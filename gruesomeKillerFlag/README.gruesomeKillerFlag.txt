BZFlag Server Plugin: gruesomeKillerFlag
================================================================================
...
gruesomeKillerFlag directory to a new name, and then manually replace gruesomeKillerFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin gruesomeKillerFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin gruesomeKillerFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin gruesomeKillerFlag,<configfilename>
For example:
  -loadplugin gruesomeKillerFlag,/path/to/my/sampleplugin.cfg
